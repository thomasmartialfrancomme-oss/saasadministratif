...
export async function POST(req:NextRequest){
  ...
  db.automations.push({id:uuid(), userId:user.id, name:'Rappel RDV veille', trigger:'RDV dans 24h', action:'Envoyer rappel', level:1, enabled:true, runs:34, simulation:false});
  writeDB(db);
